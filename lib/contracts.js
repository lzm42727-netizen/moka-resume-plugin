...
(function (root) {
  const ACTIONS = Object.freeze({
    ...
    sendFeishuCard: 'sendFeishuCard',
    feishuRecommendByScore: 'feishuRecommendByScore',
    getFeishuBridgeStatus: 'getFeishuBridgeStatus',
    reconnectFeishuBridge: 'reconnectFeishuBridge',
    disconnectFeishuBridge: 'disconnectFeishuBridge'
  });
